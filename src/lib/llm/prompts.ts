...
scenario.calculationMethod / expectedHoldingPeriod がある場合は、戦略前提に対してTarget/Stop/RiskRewardが妥当かをレビューしてください。
...
scenario.calculationMethod がある場合、Reasoningが戦略前提と矛盾した保有期間・Target/Stop評価をしていないか確認してください。
